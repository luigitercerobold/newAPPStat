...
import CirugiaContext from '../../Context/CirugiaContext'
class AgendaProducto extends Component {
   ...
   goToAgandarCirugia = (setProductos) => {

      setProductos(this.state.products )
      this.props.navigation.navigate('AgendarCirugia', { producto: this.state.products })

   }

   removeElement = (item,setProductos) => {
                        ...
                        <View style={{ flex: 1 }}>
                           ...
                           <FlatList
                              ...
                              renderItem={({ item }) =>
                                 ...
                                 <NavigateCirugia
                                    item={item}
                                    remove={()=>this.removeElement(item,setProductos)}
                                 ></NavigateCirugia>
                              }
                           />
                           <View style={{ marginBottom: 10 }}>
                              ...
                              {this.state.remove ? <ListButton title="confirmar" onPress={()=>this.goToAgandarCirugia(setProductos)} />
                                 : null
